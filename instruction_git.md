...
# **git branch** 
Команда git branch позволяет создавать, просматривать, переименовывать и удалять ветки. Если в терминале ввести команнду без дополнительных флагов (аргументов?), то гит вывелит список всех имеющихся веток. Зеленым выделит ту, где вы сейчас находитесь.

    

    git branch <имя новой ветки>

    git checkout <имя ветки на которую хотим перейти>

    git branch -d <имя ветки которую хотим удалить>

    git merge <имя ветки которую будем сливать>
